...
Enables Grails applications to take advantage of the Apache Shiro security layer, adding easy authentication and access control via roles and permissions.'''
    ...
    def documentation = "https://grails-plugins.github.io/grails-shiro/latest/"

    def license = "Apache-2.0"
    def organization = [name: "Grails Plugins", url: "https://github.com/grails-plugins/"]
    def issueManagement = [system: "Github", url: "https://github.com/grails-plugins/grails-shiro/issues"]
    def scm = [url: "https://github.com/grails-plugins/grails-shiro"]
